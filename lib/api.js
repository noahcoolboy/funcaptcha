...
async function getToken(options) {
    ...
    if (options.site) {
        ...
        options.headers["Referer"] = `${options.surl}/v2/${options.pkey}/1.5.2/enforcement.${util_1.default.random()}.html`;
    }
    ...
    let res = await (0, http_1.default)(options.surl, {
        ...
        body: util_1.default.constructFormData({
            bda: util_1.default.getBda(ua, options.pkey, options.headers["Referer"], options.location),
