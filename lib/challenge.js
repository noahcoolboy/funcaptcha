...
var Challenge = /** @class */ (function () {
    function Challenge(data, challengeOptions) {
        var _this = this;
        this.wave = 0;
        this.data = data;
    ...
    Challenge.prototype.getEmbed = function () {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, http_1.default(this.data.tokenInfo.surl, {
                            method: "GET",
                            // @ts-ignore
                            path: "/fc/gc/?" + util_1.default.constructFormData(this.data.tokenInfo),
                            headers: {
                    ...
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res.body.toString()];
                }
            });
        });
    };
...
var Challenge3 = /** @class */ (function (_super) {
    ...
    function Challenge3(data, challengeOptions) {
        var _this = _super.call(this, data, challengeOptions) || this;
        _this.answerHistory = [];
        return _this;
    }
