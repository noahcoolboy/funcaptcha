...
// Get fingerprint
function getFingerprint(canvasFp) {
    ...
    fingerprint["CFP"] = `canvas winding:yes~canvas fp:data:image/png;base64,${Buffer.from(Math.random().toString()).toString("base64")}`; //canvasFp || ''; // Canvas Fingerprint
