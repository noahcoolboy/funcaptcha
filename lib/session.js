...
class Session {
    constructor(token, sessionOptions) {
        ...
        this.tokenInfo = Object.assign({ mbio: typeof (token) !== "string" ? (_a = token.mbio) !== null && _a !== void 0 ? _a : false : false, challenge_url_cdn: typeof (token) === "object" ? token.challenge_url_cdn : "" }, parseToken(this.token));
