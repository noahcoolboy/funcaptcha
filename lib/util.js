...
var DEFAULT_USER_AGENT = 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.0.0 Safari/537.36';
var apiBreakers = {
...
function getBda(userAgent) {
    ...
    var s = JSON.stringify(bda);
    var encrypted = crypt_1.default.encrypt(s, key);
